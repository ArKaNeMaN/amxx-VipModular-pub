...
- _\[Limits\]_ Для удобства настрйоки модулей добавить ограничение `Maps` (для указания нескольких карт) и/или поддержку wildcard в названии карты
- _\[Readme\]_ Расписать ридми для стандартных лимитов
- _\[Includes\]_ Дописать доки в инклюдах 
